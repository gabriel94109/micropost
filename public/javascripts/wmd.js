...
Attacklab.wmdBase = function(){
	...
	// entering links.
          ...
          var imageDialogText = "<p style='margin-top: 0px'><b>Insert an image from the web</b>  (hosting by <a href='http://imgur.com'>imgur.com</a>)</p>";
          var linkDialogText = "<p style='margin-top: 0px'><b>Insert Hyperlink</b></p>";
	
	// The default text that appears in the dialog input box when entering
	// links.
	var imageDefaultText = "http://imgur.com/";
	...
	var helpHoverTitle = "Markdown Syntax Guide";
	...
	wmd.Chunks.prototype.addBlankLines = function(nLinesBefore, nLinesAfter, findExtraNewlines){
		...
		var replacementText;
                ...
                //http://meta.stackoverflow.com/questions/63307/blockquote-glitch-in-editor-in-chrome-6-and-7
                if (navigator.userAgent.match(/Chrome\/7/)) {
                  "X".match(/()./);
                }
